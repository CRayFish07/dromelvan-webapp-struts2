...
<head>
    <title>Drömelvan > Premier League > <struts:property value="spelareSasongStatistik.spelare.namn"/> - Säsongstatistik <struts:property value="spelareSasongStatistik.sasong.namn"/></title>
...
<body id="body">
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <h3>Säsongstatistik <struts:property value="spelareSasongStatistik.sasong.namn"/></h3>

            <%@ include file="include/spelare_header.jsp" %>

            <table class="top" id="matcher">
                <colgroup>
                ...
                <tr>
                    <td><struts:property value="match.kortDatumStr"/></td>
                    <td>
            ...
            <tr class="tabell_forklaring">
                <td colspan="13">Res. = Resultat M = Mål SM = Självmål A = Assist GK = Gula kort RK = Röda kort R = Rating P = Poäng</td>                
            </tr>
            </table>
        </div>
