...
<head>
    <title>Drömelvan > Drömelvan > Tabell <struts:property value="tavling.sasong.namn"/></title>
...
<body id="body">
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <h3><struts:property value="tavling.namn"/> <struts:property value="tavling.sasong.namn"/><struts:if test="haltande"> - Haltande tabell</struts:if></h3>
