...
<head>
    <title>Drömelvan > Premier League > Omgångens skamlag - <struts:property value="omgang.namn"/> <struts:property value="omgang.tavling.sasong.namn"/></title>
...
<body id="body">
    ...
    <div id="sidebar">
        ...
        <div id="context" class="group">
            <h3>Omgångens skamlag</h3>
            <h4 class="top">Omgångens skamlag</h4>
            <ul>
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <h3>Omgångens skamlag - <struts:property value="omgang.namn"/> <struts:property value="omgang.tavling.sasong.namn"/></h3>

            <div class="lag_header">
                <img class="lag_klubbmarke" src="bilder/omgangens_skamlag.gif" alt="Omgångens skamlag"/>
                <table>
                    <colgroup>
                    ...
                    <tr>
                        <td>Poäng: <struts:property value="omgangensSkamLagStatistik.poang"/></td>
                        <td>Mål: <struts:property value="omgangensSkamLagStatistik.antalMal"/></td>
                    </tr>
                    <tr>
                        <td>Gula kort: <struts:property value="omgangensSkamLagStatistik.antalGultKort"/></td>
                        <td>Röda kort: <struts:property value="omgangensSkamLagStatistik.antalRottKort"/></td>
                    </tr>
                    <tr>
                        <td>MoM: <struts:property value="omgangensSkamLagStatistik.antalMom"/></td>
                        <td>Delad MoM: <struts:property value="omgangensSkamLagStatistik.antalDeladMom"/></td>
                    </tr>
                    <tr>
                        <td>Medelrating: <struts:property value="omgangensSkamLagStatistik.medelRating"/></td>
                        <td>Medelpoäng: <struts:property value="omgangensSkamLagStatistik.medelPoang"/></td>
                    </tr>
                </table>
            </div>

            <table id="omgangens_skamlag">
                <colgroup>
                ...
                <struts:iterator value="omgangensSkamLagStatistik.spelareMatchStatistik">
                <tr>
                    <td class="spelare">
