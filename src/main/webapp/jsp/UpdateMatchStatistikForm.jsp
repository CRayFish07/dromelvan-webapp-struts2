    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <div class="match_input">
                <p>
                    Välj en .xml fil med statistik om matchen och klicka på 'Uppdatera' för att skicka den
                    till servern. Om filen är korrekt kommer statistik för matchen att uppdateras.
                </p>            
                ...
                <p>
                    <struts:url var="url" action="InsertSpelareForm">
                        ...
                        <struts:param name="ny" value="true"/>
                    </struts:url>                            
